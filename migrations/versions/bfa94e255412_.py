...
Revision ID: bfa94e255412
Revises: e8717b8947bc
Create Date: 2020-08-12 14:38:34.820666
...
revision = 'bfa94e255412'
down_revision = 'e8717b8947bc'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('geners', sa.String(length=120), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    op.drop_table('Venue')
